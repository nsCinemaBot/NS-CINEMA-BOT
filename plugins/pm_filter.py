...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/NS_CINEMAGALU1')
        ], [
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("Didn't find anything related to this query ! \n\n Check your spelling or discuss with admin here 👉 @NPLOVER_ADMIN ")
        await asyncio.sleep(8)
        await k.delete()
        return
    ...
    await msg.reply("Didn't find anything related to this query ! \n\n Check your spelling or discuss with admin here 👉 @NPLOVER_ADMIN",
                    reply_markup=InlineKeyboardMarkup(btn))
